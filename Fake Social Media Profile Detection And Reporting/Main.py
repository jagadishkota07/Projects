...
main = Tk()
main.title("Fake Social Media Profile Detection And Reporting")
...
def Developer():
    outputarea.delete('1.0', END)
    outputarea.insert(END,10*"   "+10*"*"+"G.Ashlesha, Kotagoda Jagadish, P.Rajashekar, Tekale Srinath"+10*"*")
        
def close():
    main.destroy()

font = ('times', 15, 'bold')
title = Label(main, text='Fake Social Media Profile Detection And Reporting')
...
projectButton = Button(main, text="Project Developers", command=Developer)
projectButton.place(x=20,y=400)
projectButton.config(font=ff)
...
#project developers -> G.Ashlesha, Kotagoda Jagadish, P.Rajashekar, Tekale Srinath